<?php
// ATP - prof_reg.php
// Instructor registration page using PDO.
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $sql = "INSERT INTO Instructors (ID, Name, PhoneNo, Email, Username, Password) VALUES (:id, :name, :phone, :email, :username, :password)";
...
<body>
  <div class="register-box">
    ...
    <form method="POST" action="">
      ...
      <p class="note">Already have an account? <a href="prof_login.php" class="link">Login</a></p>
    </form>
  </div>
</body>
