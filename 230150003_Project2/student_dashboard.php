          ...
          <?php
            ...
            if ($result1->num_rows > 0) {
              while ($row1 = $result1->fetch_assoc()) {
                $status_class = strtolower($row1['StatusOfCompletion']) == 'completed' ? 'status-complete' :
                                (strtolower($row1['StatusOfCompletion']) == 'in progress' ? 'status-progress' : 'status-pending');
